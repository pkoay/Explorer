...
namespace WalzExplorer.Controls.RHSTabs.Tender
{
    ...
    public partial class UnitOfMeasureView : RHSTabViewBase
    {

        UnitOfMeasureViewModel vm;
       ...
       public UnitOfMeasureView()
        ...
        {
            vm = new UnitOfMeasureViewModel(settings);
            grd.vm = vm;
            ...
            grd.columnsettings.Add("UnitOfMeasureID", new GridEditViewBase.columnSetting() { isDeveloper = true });
