...
namespace WalzExplorer.Controls.RHSTabs.Project
{
    ...
    public partial class CostBudgetVsActualView : RHSTabViewBase
    {

        CostBudgetVsActualViewModel vm;

        public CostBudgetVsActualView()
        {
            InitializeComponent();
        }
        ...
        public override void TabLoad()
        {
            ...
            vm = new CostBudgetVsActualViewModel(settings);
