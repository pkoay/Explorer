...
namespace WalzExplorer.Controls.RHSTabs.Project
{
    ...
    {
        public ObservableCollection<spWEX_RHS_Project_Summary_v3_Result> data;
        ...
        public SummaryViewModel (WEXSettings settings) //(string NodeType, string PersonID, int Id)
        {
            ...
            data = new ObservableCollection<spWEX_RHS_Project_Summary_v3_Result>(context.spWEX_RHS_Project_Summary_v3(UserPersonID, NodeTypeID, settings.SearchCriteria, ProjectID, ManagerID, CustomerID));  
        }
    }
}
