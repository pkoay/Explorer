...
namespace WalzExplorer.Controls.RHSTabs.Project
{
    ...
    {
        public ObservableCollection<spWEX_RHS_Project_PurchaseOrderSummary_Result> data;
        ...
        public PurchaseOrderSummaryViewModel(WEXSettings settings) //(string NodeType, string PersonID, int Id)
        {
            ...
            data = new ObservableCollection<spWEX_RHS_Project_PurchaseOrderSummary_Result>(context.spWEX_RHS_Project_PurchaseOrderSummary(ProjectID)); 
