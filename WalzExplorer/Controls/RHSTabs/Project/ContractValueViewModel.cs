...
{
    public class ContractValueViewModel 
    {
        public ObservableCollection<spWEX_RHS_Project_ContractValue_Result> data;
        ...
        public ContractValueViewModel(WEXSettings settings) //(string NodeType, string PersonID, int Id)
        {
            ...
            data = new ObservableCollection<spWEX_RHS_Project_ContractValue_Result>(context.spWEX_RHS_Project_ContractValue(ProjectID)); 
