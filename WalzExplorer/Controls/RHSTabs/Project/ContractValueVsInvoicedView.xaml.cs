...
namespace WalzExplorer.Controls.RHSTabs.Project
{
    ...
    public partial class ContractValueVsInvoicedView : RHSTabViewBase
    {

        ContractValueVsInvoicedViewModel vm;

        public ContractValueVsInvoicedView()
        {
            InitializeComponent();
        }
        ...
        public override void TabLoad()
        {
            ...
            vm = new ContractValueVsInvoicedViewModel(settings);
