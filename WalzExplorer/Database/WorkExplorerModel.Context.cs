...
namespace WalzExplorer.Database
{
    ...
    public partial class WalzExplorerEntities : DbContext
    {
        ...
        public virtual ObjectResult<spWEX_RHS_Project_ContractValueVsInvoiced_Result> spWEX_RHS_Project_ContractValueVsInvoiced(Nullable<int> projectID)
        {
            var projectIDParameter = projectID.HasValue ?
                new ObjectParameter("ProjectID", projectID) :
                new ObjectParameter("ProjectID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spWEX_RHS_Project_ContractValueVsInvoiced_Result>("spWEX_RHS_Project_ContractValueVsInvoiced", projectIDParameter);
        }
    }
}
